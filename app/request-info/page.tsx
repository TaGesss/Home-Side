        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
            <section className="py-6">
              <h1 className="text-3xl md:text-4xl font-extrabold text-primary mb-4">Request Info</h1>
              <p className="text-lg text-primary-light mb-6">Fill out the form to request samples, availability, quotes, or general information. Select the type of request and provide details for a tailored response.</p>
              <div className="bg-white/60 backdrop-blur-md rounded-xl p-6 shadow-sm border border-white/30">
                <h3 className="font-semibold mb-2">Why request info?</h3>
