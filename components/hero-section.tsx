      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-2">
          <h1
            ...
            "
          >
           Home Side Trading P.L.C, International Export & Import Company Based in 
          </h1>
          <h1
            className="
              text-6xl md:text-5xl 
          ...
          <p className="text-xl text-primary-light">
            <p>
  Import and Export company, specializing in global trade of agricultural products, livestock and meat, vehicles, and industrial equipment.
</p>
